...
class FirstTerminalViewStudent extends StatefulWidget {
  const FirstTerminalViewStudent({super.key});

  @override
  State<FirstTerminalViewStudent> createState() =>
      _FirstTerminalViewStudentState();
}

class _FirstTerminalViewStudentState extends State<FirstTerminalViewStudent> {
